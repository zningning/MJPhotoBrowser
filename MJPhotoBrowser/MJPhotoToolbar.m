...
//        [self addSubview:_indexLabel];
        ...
        _pageControll = [[UIPageControl alloc] initWithFrame:self.bounds];
        _pageControll.numberOfPages = photos.count;
        _pageControll.backgroundColor = [UIColor clearColor];
        _pageControll.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
...
//    _indexLabel.text = [NSString stringWithFormat:@"%d / %d", _currentPhotoIndex + 1, _photos.count];
    _pageControll.currentPage = currentPhotoIndex;
